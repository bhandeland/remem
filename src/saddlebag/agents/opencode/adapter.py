"""Installs saddlebag into opencode: one generated plugin file, and nothing else.
...
from saddlebag.agents.base import RECORD_NOTE, HarnessEvent, Identity, InstallReport
from saddlebag.agents.opencode.install import plugin_dir
...
class OpenCodeAdapter:
    ...
    #: of saddlebag.agents.opencode.hooks.HOOK_NAMES - subscribing to a hook
    ...
    def install(
        ...
        matter. saddlebag owns saddlebag.js - a user who wants to keep local edits
        ...
        target = target_dir / "saddlebag.js"
        source = resources.files("saddlebag.agents.opencode") / "plugin.js"
    ...
    def identity(self, env: Mapping[str, str], payload: dict[str, Any]) -> Identity:
        ...
        return Identity(
            ...
            # to, the same as every other write path in saddlebag.

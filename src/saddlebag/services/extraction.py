...
harnesses saddlebag targets do not have one.
"""
...
from saddlebag.domain import Event, ExtractJob, JobStatus, Origin, Query, SessionRef
from saddlebag.extract.base import ExtractedEntry, ExtractionFailed, Extractor
...
def awaiting_sessions(
    ...
    and `bag record status` used to apply this in two places (Python here,

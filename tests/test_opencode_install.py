...
saddlebag owns plugin.js: no version marker, no merge, no prompt. The file is
...
def test_user_scope_writes_the_plugin_under_the_config_directory(
    ...
    plugin = tmp_path / ".config" / "opencode" / "plugin" / "saddlebag.js"
    assert plugin.exists()
    assert plugin.read_text().startswith("// generated by saddlebag - do not edit")
...
def test_project_scope_writes_beside_the_repository(
    ...
    assert (tmp_path / ".opencode" / "plugin" / "saddlebag.js").exists()
...
def test_project_scope_from_a_subdirectory_writes_at_the_repository_root(
    ...
    `<subdir>/.opencode/plugin/saddlebag.js` - a location opencode, which scans
    ...
    assert (repo / ".opencode" / "plugin" / "saddlebag.js").exists()
...
def test_a_second_install_overwrites_a_modified_plugin(
    ...
    """No version marker, unconditional overwrite. saddlebag owns the file."""

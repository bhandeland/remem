...
from saddlebag.agents.base import Kind
...
def test_every_entry_carries_one_line_of_help():
    # The help string is what makes `bag config list` self-documenting,
...
def test_no_credential_or_endpoint_is_ever_settable(forbidden: str) -> None:
    # saddlebag must never be the tool that writes a credential into a JSON file
